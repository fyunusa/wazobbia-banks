"""
Specialized Deep Crawler for OPay - Fast and responsive fintech site

OPay's website is modern and responsive with fast page loads.
This crawler is optimized for their lightweight infrastructure.
"""
...
logger = logging.getLogger("deep_crawl_opay")

# Configuration
BANK_HOME = "https://www.opayweb.com"
DATA_DIR = Path("data/opay")
TIMEOUT = 45000  # 45 seconds - OPay is fast
SAME_ORIGIN_ONLY = True

# Browser headers for OPay
BROWSER_HEADERS = {
...
CATEGORIES = {
    "personal": ["personal", "individual", "savings", "account"],
    "business": ["business", "sme", "merchant", "commercial"],
    "features": ["features", "product", "service"],
    "support": ["support", "help", "faq", "customer", "contact"],
    "about": ["about", "company", "why", "careers"],
    "blog": ["blog", "news", "press", "newsroom"],
}


class OpayDeepCrawler:
    """Specialized crawler for OPay fintech platform."""
    ...
    async def crawl(self):
        ...
        logger.info(f"🚀 Starting deep crawl of OPAY")
        logger.info(f"🔗 Homepage: {BANK_HOME}")
        logger.info(f"📁 Output: {DATA_DIR}")
        logger.info(f"⏱️  Timeout: {TIMEOUT}ms (45 seconds)")
