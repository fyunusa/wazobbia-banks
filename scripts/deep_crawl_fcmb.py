"""Specialized Deep Crawler for FCMB"""
...
logger = logging.getLogger("deep_crawl_fcmb")

BANK_HOME = "https://www.fcmb.com"
DATA_DIR = Path("data/fcmb")
TIMEOUT = 60000

class FcmbDeepCrawler:
    def __init__(self):
    ...
    async def crawl(self):
        ...
        logger.info(f"🚀 Starting deep crawl of FCMB")
        ...
        with open(DATA_DIR / "index.json", "w") as f:
            json.dump({"bank": "FCMB", "total_pages": self.page_count}, f)
