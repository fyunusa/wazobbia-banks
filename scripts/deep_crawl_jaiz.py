"""Specialized Deep Crawler for Jaiz Bank"""
...
logger = logging.getLogger("deep_crawl_jaiz")

BANK_HOME = "https://www.jaizbank.com/"
DATA_DIR = Path("data/jaiz")
TIMEOUT = 60000

class JaizDeepCrawler:
    def __init__(self):
    ...
    async def crawl(self):
        ...
        logger.info(f"🚀 Starting deep crawl of JAIZ BANK")
        ...
        with open(DATA_DIR / "index.json", "w") as f:
            json.dump({"bank": "Jaiz", "total_pages": self.page_count}, f)
