"""Specialized Deep Crawler for Keystone Bank"""
...
logger = logging.getLogger("deep_crawl_keystone")

BANK_HOME = "https://www.keystonebank.com.ng/"
DATA_DIR = Path("data/keystone")
TIMEOUT = 60000

class KeystoneDeepCrawler:
    def __init__(self):
    ...
    async def crawl(self):
        ...
        logger.info(f"🚀 Starting deep crawl of KEYSTONE BANK")
        ...
        with open(DATA_DIR / "index.json", "w") as f:
            json.dump({"bank": "Keystone", "total_pages": self.page_count}, f)
...
async def main():
    await KeystoneDeepCrawler().crawl()
