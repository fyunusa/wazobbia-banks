"""Specialized Deep Crawler for Providus Bank"""
...
logger = logging.getLogger("deep_crawl_providus")

BANK_HOME = "https://www.providusbank.com/"
DATA_DIR = Path("data/providus")
TIMEOUT = 60000

class ProvidusDeepCrawler:
    def __init__(self):
    ...
    async def crawl(self):
        ...
        logger.info(f"🚀 Starting deep crawl of PROVIDUS BANK")
        ...
        with open(DATA_DIR / "index.json", "w") as f:
            json.dump({"bank": "Providus", "total_pages": self.page_count}, f)
...
async def main():
    await ProvidusDeepCrawler().crawl()
