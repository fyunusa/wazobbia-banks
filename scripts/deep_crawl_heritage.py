"""Specialized Deep Crawler for Heritage Bank"""
...
logger = logging.getLogger("deep_crawl_heritage")

BANK_HOME = "https://www.heritagebank.com.ng/"
DATA_DIR = Path("data/heritage")
TIMEOUT = 60000

class HeritageDeepCrawler:
    def __init__(self):
    ...
    async def crawl(self):
        ...
        logger.info(f"🚀 Starting deep crawl of HERITAGE BANK")
        ...
        with open(DATA_DIR / "index.json", "w") as f:
            json.dump({"bank": "Heritage", "total_pages": self.page_count}, f)
...
async def main():
    await HeritageDeepCrawler().crawl()
