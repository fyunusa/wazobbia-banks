"""Specialized Deep Crawler for Wema Bank"""
...
logger = logging.getLogger("deep_crawl_wema")

BANK_HOME = "https://www.wemabank.com/"
DATA_DIR = Path("data/wema")
TIMEOUT = 60000

class WemaDeepCrawler:
    def __init__(self):
    ...
    async def crawl(self):
        ...
        logger.info(f"🚀 Starting deep crawl of WEMA BANK")
        ...
        with open(DATA_DIR / "index.json", "w") as f:
            json.dump({"bank": "Wema", "total_pages": self.page_count}, f)
