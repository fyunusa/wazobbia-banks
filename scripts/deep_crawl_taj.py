"""Specialized Deep Crawler for TAJ Bank"""
...
logger = logging.getLogger("deep_crawl_taj")

BANK_HOME = "https://www.tajbank.com"
DATA_DIR = Path("data/taj")
TIMEOUT = 60000

class TajDeepCrawler:
    def __init__(self):
    ...
    async def crawl(self):
        ...
        logger.info(f"🚀 Starting deep crawl of TAJ BANK")
        ...
        with open(DATA_DIR / "index.json", "w") as f:
            json.dump({"bank": "TAJ", "total_pages": self.page_count}, f)
