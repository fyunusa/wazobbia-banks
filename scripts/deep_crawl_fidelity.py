"""Specialized Deep Crawler for Fidelity Bank"""
...
logger = logging.getLogger("deep_crawl_fidelity")

BANK_HOME = "https://www.fidelitybank.ng/"
DATA_DIR = Path("data/fidelity")
FILES_DIR = DATA_DIR / "files"
TIMEOUT = 60000

FILES_DIR.mkdir(parents=True, exist_ok=True)

class FidelityDeepCrawler:
    def __init__(self):
    ...
    async def crawl(self):
        ...
        logger.info(f"🚀 Starting deep crawl of FIDELITY BANK")
        ...
        with open(DATA_DIR / "index.json", "w") as f:
            json.dump({"bank": "Fidelity", "total_pages": self.page_count}, f)
...
async def main():
    await FidelityDeepCrawler().crawl()
